...
export const metadata: Metadata = {
  ...
  openGraph: { title: "AI that works for your business.", description: "AI employees that answer, qualify, follow up, book and automate repetitive work.", images: ["/hbl-001-supreme-clinic-demo/og.png"] },

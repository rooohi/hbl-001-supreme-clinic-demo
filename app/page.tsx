...
export default function Home() { return <><Header/><main>
  <section className="center-hero" id="top"><div className="hero-wash wash-green"/><div className="hero-wash wash-blue"/><div className="container center-hero-inner">
    ...
    <h1>Turn customer requests<br/><em>into finished work.</em></h1>
    ...
    <div className="abstract-system"><Image src="/hbl-001-supreme-clinic-demo/hero-intelligence-network-v2.png" alt="A luminous intelligence network connecting one request to several governed business outcomes" width={1536} height={1024} priority sizes="(max-width: 900px) 100vw, 1100px"/><div className="system-caption"><span><ShieldCheck/> Permitted actions</span><span><CirclesFour/> Connected tools</span><span><UsersThree/> Named human owner</span></div></div>
  </div></section>

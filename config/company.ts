...
export const company = {
  ...
  description: "Operational AI roles and connected workflows that understand requests, use approved knowledge, take permitted actions and keep human review visible.",
